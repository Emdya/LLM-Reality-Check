...
async function handleVerification(tabId, data) {
  try {
...
async function simulateFactCheckAPI(content) {
  // Simulate API delay
...
function highlightFalseInformation(tabId, falseInfo) {
  chrome.tabs
    .sendMessage(tabId, {
...
function sendCorrectionToAI(tabId, correction) {
  chrome.tabs
    .sendMessage(tabId, {
