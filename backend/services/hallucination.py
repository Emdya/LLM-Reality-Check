...
class HallucinationDetector:
    ...
    def detect_hallucinations(self, prompt: str, response: str, threshold: float = 0.75) -> Dict:
        ...
        self.vector_search.corpus.clear()
        self.vector_search.corpus.add_from_wikipedia(prompt)
        self.vector_search.corpus.add_from_pubmed(prompt)
        self.vector_search.corpus._build_index()
